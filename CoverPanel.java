    ...
    public CoverPanel(Order order) {
        ...
        addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(java.awt.event.MouseEvent e){
                JFrame topFrame =(JFrame) SwingUtilities.getWindowAncestor(CoverPanel.this);
                topFrame.dispose();
                PanelTester.testPanel( new MainOrderPanel(order),"Food Order App");
            }
        });
    }
